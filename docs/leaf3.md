...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | default | 172.100.100.15/24 | 172.100.100.1 |
...
| --- | ------------------ | ----------------------- | ------------------- | ----------------------------- | ----------------- | ----------------------------- | -------------- |
| default | 0.0.0.0/0 | 172.100.100.1 | - | 1 | - | - | - |
...
| --- | ------------------- | ------------ | -------------- |
| Tenant_A_OP_Zone | 192.0.255.5:10 | connected | IPv4: False<br>Transit: False |
